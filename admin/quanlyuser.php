                        ...
                        <div class="col-12">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="xoanhieuuser.php" method="GET">
                                        <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                                            ...
                                            <?php 
                                                ...
                                                $sql="SELECT * FROM tai_khoan LIMIT $begin,10";
                                                $sqlquery=mysqli_query($con,$sql);
                                                $l=-1;
                                                $l++;
                                                $us="SELECT * FROM tai_khoan WHERE power='nhan vien' or power='khach hang' or power='admin' LIMIT $begin,10";
                                                $quer=mysqli_query($con,$us);
                                                while($rows=mysqli_fetch_array($quer)){
                                                    if($rows['status']!='xoa'){
                                            ?>
                                            <td><input type="checkbox" name="user<?php echo $rows['ID'];  ?>" value="<?php echo $rows['ID']; ?>" id="xoanhieu"></td>
                                            ...
                                            <td><a href="xoauser.php?id=<?php echo $rows['ID']; ?>" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fas fa-trash-alt"></i>Xóa</a></td>
                                            <td><a href="khoauser.php?id=<?php echo $rows['ID']; ?>" <?php if($rows['status']=='normal'){echo "onclick=\"return confirm('Are you sure you want to lock this user?')\""; }else{echo "onclick=\"return confirm('Are you sure you want to unlock this user?');\"";} ?>><?php if($rows['status']=='normal'){echo "<i class='fas fa-lock'></i>Khóa"; }else{ echo "<i class='fas fa-lock-open'></i>Mở khóa";} ?></a></td>
                                        ...
                                        <?php 
                                        $sqltrang=mysqli_query($con,"SELECT * FROM tai_khoan");
                                        ...
                                        <ul class="pagination" style="display: inline-block">
                                            ...
                                            ?>
                                            <li style="border:1px solid blue;width: 60px;float:left"><a href="quanlyuser.php?trang=<?php echo $i; ?>"><?php echo $i ?></a></li>
                                            <?php } ?>
