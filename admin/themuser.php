...
<body class="adminbody">
    ...
    <div id="main">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <form action="xulythemuser.php" method="POST" name='formthemuser' id="formthemuser">
                                            <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                                                <tr>
                                                    <td><label>Username:</label></td>
                                                    <td><input type="text" name="username" id="username" placeholder="Username"></td>
                                                    <td><div id="usernameer"></div></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="hoten" id="hoten" placeholder="VD:Binladen"></td>
                                                    <td><div id="hotener"></div></td>
                                                </tr>
                                                <tr>
                                                    <td><label>Date of birth:</label></td>
                                                    <td><input type="date" name="date" placeholder="2021-1-1" required></td>
                                                    
                                                </tr>
                                                <tr>
                                                    <td><label>Phone number:</label></td>
                                                    <td><input type="text" name="sodienthoai" id="sodienthoai" placeholder="090xxxxxxx"></td>
                                                    <td><div id="sdter"></div></td>
                                                </tr>
                                                <tr>
                                                    <td><label>Sex:</label></td>
                                                    <td>Nam<input type="radio" name="gioitinh" value="nam" required>Nữ<input type="radio" name="gioitinh" value="nu" required></td>
                                                    
                                                </tr>
                                                <tr>
                                                    <td><label>Email:</label></td>
                                                    <td><input type="text" name="email" id="email" placeholder="VD:Binladen@gmail.com"></td>
                                                    <td><div id="emailer"></div></td>
                                                </tr>
                                                <tr>
                                                    <td><label>Address:</label></td>
                                                    <td><input type="text" name="diachi" id="diachi" placeholder="VD:Việt Nam"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><div id="powerer"></div></td>
                                                </tr>

                                                <tr>
                                                    <td colspan='3'><input type="submit" name="submit" value="Add user"></td>
                                                </tr>
        ...
        $(document).ready(function(){
           $( "#formthemuser" ).submit(function( event ) {
                ...
                var power=$("#chucvu").val();
				var flag=true;
				if(username==''){
					$("#usernameer").html("<div id='usernameer' style='color:red'>Vui lòng nhập username</div>");
					flag=false;
				}else if(ischu(username)){
                    $("#usernameer").html("<div id='usernameer' style='color:red'>Username không được có kí tự đặc biệt</div>");
					flag=false;
                }else{
					$("#usernameer").html("<div id='usernameer' style='color:red'></div>");
				}

				if(password==''){
					$("#passworder").html("<div id='passworder' style='color:red'>Vui lòng nhập password</div>");
					flag=false;
				}else if(password.length<8 ){
					$("#passworder").html("<div id='passworder' style='color:red'>Mật khẩu của bạn phải trên 8 kí tự</div>");
					flag=false;
				}else{
                ...
                if(power==''){
                    $("#powerer").html("<div id='powerer' style='color:red'>Vui lòng chọn chức vụ</div>");
					flag=false;
                }else{
                    $("#powerer").html("<div id='powerer' style='color:red'></div>");
					flag=false;
                }
