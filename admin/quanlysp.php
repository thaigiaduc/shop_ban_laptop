                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <form action="xoanhieu.php" method="GET">
                                        <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                                           
                                            <thead>
                                                <tr>
                                                    <th>Select</th>
                                                    <th><a href="quanlysp.php?query=<?php if(isset($_GET['query'])==''){echo "SELECT * FROM sanpham ORDER BY ID DESC";}else if($_GET['query']=="SELECT * FROM sanpham ORDER BY ID DESC"){echo "SELECT * FROM sanpham ORDER BY ID ASC";}else{echo "SELECT * FROM sanpham ORDER BY ID DESC";}  ?>">ID</a></th>
                                                    <th><a href="quanlysp.php?query=<?php if(isset($_GET['query'])==''){echo "SELECT * FROM sanpham ORDER BY Loai DESC";}else if($_GET['query']=="SELECT * FROM sanpham ORDER BY Loai DESC"){echo "SELECT * FROM sanpham ORDER BY Loai ASC";}else{echo "SELECT * FROM sanpham ORDER BY Loai DESC";}  ?>">Loại</a></th>
                                                    <th><a href="quanlysp.php?query=<?php if(isset($_GET['query'])==''){echo "SELECT * FROM sanpham ORDER BY Hinh DESC";}else if($_GET['query']=="SELECT * FROM sanpham ORDER BY Hinh DESC"){echo "SELECT * FROM sanpham ORDER BY Hinh ASC";}else{echo "SELECT * FROM sanpham ORDER BY Hinh DESC";}  ?>">Hinh</a></th>
                                                    <th><a href="quanlysp.php?query=<?php if(isset($_GET['query'])==''){echo "SELECT * FROM sanpham ORDER BY Tensp DESC";}else if($_GET['query']=="SELECT * FROM sanpham ORDER BY Tensp DESC"){echo "SELECT * FROM sanpham ORDER BY Tensp ASC";}else{echo "SELECT * FROM sanpham ORDER BY Tensp DESC";}  ?>">Tên sản phẩm</a></th>
                                                    <th><a href="quanlysp.php?query=<?php if(isset($_GET['query'])==''){echo "SELECT * FROM sanpham ORDER BY Gia DESC";}else if($_GET['query']=="SELECT * FROM sanpham ORDER BY Gia DESC"){echo "SELECT * FROM sanpham ORDER BY Gia ASC";}else{echo "SELECT * FROM sanpham ORDER BY Gia DESC";}  ?>">Giá</a></th>
                                                    <th><a href="quanlysp.php?query=<?php if(isset($_GET['query'])==''){echo "SELECT * FROM sanpham ORDER BY soluong DESC";}else if($_GET['query']=="SELECT * FROM sanpham ORDER BY soluong DESC"){echo "SELECT * FROM sanpham ORDER BY soluong ASC";}else{echo "SELECT * FROM sanpham ORDER BY soluong DESC";}  ?>">Số lượng</a></th>
                                                    
                                                    <th>Sửa</th>
                                                    <th>Xóa</th>
                                                    <th><button type="submit" name="submit" value=""><i class="fas fa-trash-alt"></i></button></th>
                                                </tr>
                                            </thead>
                                            
                                            <?php 
                                            // $_SESSION['sp']="SELECT * FROM sanpham ORDER BY ID DESC";
                                            if(isset($_GET['trang'])){
                                                $page=$_GET['trang'];
                                            }else{
                                                $page='';
                                            ...
                                            $sql="SELECT * FROM sanpham LIMIT $begin,10";
                                            ...
                                            if(isset($_GET['query'])){
                                                ...
                                                $sp="SELECT * FROM sanpham LIMIT $begin,10";
                                            }
                                            ...
                                            <tr>
                                                <td><input type="checkbox" name="sanpham<?php echo $row['ID']-10000; ?>" value="<?php echo $row['ID']; array_push($mangtam,$row['ID']); $_SESSION['luuxoa']=$mangtam; ?>" id="xoanhieu"></td>
                                                <td><?php echo $row['ID']; ?></td>
                                                <td><?php echo $row['Loai']; ?></td>
                                                <td><img src="<?php echo "../".$row['Hinh']; ?>" style="width: 100px"></td>
                                                <td><?php echo $row['Tensp']; ?></td>
                                                <td><?php echo $row['Gia']; ?></td>
                                                <td><?php echo $row['soluong']; ?></td>
                                                <td><a href="suasp.php?idsua=<?php echo $row['ID']; ?>"><i class="fas fa-edit"></i>Sửa</a></td>
                                                
                                                <td><a href="xoasp.php?idxoa=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to delete this product?');"><i class="fas fa-trash-alt"></i>Xóa</a></td>
                                            </tr>
                                            <?php } } ?>
                                        </table>
                                        </form>
                                        ...
                                        <ul class="pagination" style="display: inline-block">
                                            ...
                                            ?>
                                            <li style="border:1px solid blue;width: 60px;float:left"><a href="quanlysp.php?trang=<?php echo $i; ?>"><?php echo $i ?></a></li>
                                            <?php } ?>
