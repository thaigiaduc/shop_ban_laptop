...
if(isset($_GET['trang']) && isset($_GET['brand'])){
    $page=$_GET['trang'];
...
$sql="SELECT * FROM sanpham WHERE '$br'=theloai LIMIT $begin,9";
...
<div class="panigtion" style="text-align:center">
            <?php 
            $sqltrang=mysqli_query($con,"SELECT * FROM sanpham WHERE '$br'=theloai");
            ...
            ?>
                ...
                <li class="page-item">
                    ...
                    ?>
                    <li><a href="shop.php?quanly=danhmucsanpham&brand=asus&trang=<?php echo $i; ?>"><?php echo $i ?></a></li>
                    <?php } }?>
                    <li class="page-item">
