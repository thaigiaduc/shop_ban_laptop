			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="images/pic13.jpg" alt=""></span>
					</div>
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="images/pic2.jpg" alt=""></span>
					</div>
					<div class="product-details">
						<a href="#">
			...
			<div class="col-md-4">
				<div class="productbox">
					<div class="fadeshop">
						...
						<span class="maxproduct"><img src="images/Gaming.jpg" alt=""></span>
					</div>
					<div class="product-details">
						<a href="#">
						<h1>Biscaya Theme</h1>
		...
		<div class="col-md-10 col-md-offset-1">
			<div class="slide-text">
				<div>
					...
					<img src="images/ducdeptrai.jpg" alt="Awesome Support">
					<p>
